...
// it (set_wallpaper.sh runs `wal -i ...` on every wallpaper change). This is
// what bakes theming into finder — no separate "rebuild finder's theme" step
// is needed the way walker needed update-walker-theme.sh to rewrite its CSS
// and restart; these properties just update in place and every binding that
// reads them repaints.
// Usage: WalColors.background, WalColors.foreground, WalColors.color0 … color15
QtObject {
    id: root

    property string background: "#050810"
    property string foreground: "#a8aeba"
    property string color0:  "#050810"
    property string color1:  "#364A67"
    ...
    property string color7:  "#a8aeba"
    property string color8:  "#757982"
