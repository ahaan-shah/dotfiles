...
// it (set_wallpaper.sh runs `wal -i ...` on every wallpaper change). Same
// singleton used by finder/ and macdock/ — copied here since each Quickshell
// app (`-c <dir>`) is its own isolated instance with no shared QML module.
